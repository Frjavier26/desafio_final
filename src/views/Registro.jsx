      ...
      {error ? <p>Todos los campos son obligatorios</p> : null}
        <Row className="mb-3">
          <Form.Group as={Col} controlId="formGridEmail">
            ...
            <input className="form-control" type='email' name="password" onChange={(e) => setEmail(e.target.value)} />
          </Form.Group>
        ...
        <Form.Group className="mb-3" controlId="formGridAddress2">
          ...
          <input className="form-control" name="apellido" onChange={(e) => setApellido(e.target.value)} />
        </Form.Group>
